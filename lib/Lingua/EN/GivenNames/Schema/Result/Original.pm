use utf8;
package Lingua::EN::GivenNames::Schema::Result::Original;
...
=head1 TABLE: C<originals>

=cut

__PACKAGE__->table("originals");
...
__PACKAGE__->has_many(
  ...
  { "foreign.original_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07015 @ 2012-07-31 17:19:40
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:QFitXaCInL75yfCWcxgL9Q
